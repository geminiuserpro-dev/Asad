export function Hero({ setView }: any) {
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <a href="#" className="announcement-pill">
          <span className="pill-badge">New</span>
          <span className="pill-text">Try the Lovable mobile app</span>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M6 4L10 8L6 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </a>
        <h1 className="hero-title">Build something<br /><span className="hero-title-accent">Lovable</span></h1>
        <p className="hero-subtitle">Create apps and websites by chatting with AI</p>

        <div className="chat-input-container">
          <div className="chat-input-box">
            <textarea className="chat-textarea" placeholder="Ask Lovable to create a prototype..." rows={3}></textarea>
